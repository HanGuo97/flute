...
> [!WARNING]
> We noticed several numerically unstable situations using `bits=4, group-size=256, GPU=A100`, though this is relatively rare (8 of 9360 test cases failed). We also noticed correctness issues in some situations with `bits=4, group-size=256, GPU=RTX4090`. We will be looking into this, but we suggest avoiding these particular use cases for now. 
